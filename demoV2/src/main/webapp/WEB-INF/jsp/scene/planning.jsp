                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <h3>
                             ...
                             <form action='<%= request.getContextPath() %>/search_is_validate/<%= scene %>' method="post">
                                <select name="search">
                                <option>Choisir l'etat de l'action</option>
                                <option value="1">Validee</option>
                                <option value="0">Non Validee</option>
                                </select>
...
<%--                                                </small></h5>--%>
                                                ...
                                                <h3>
                                                    <small class="even-row-color" style="color: red">pas encore tournee</small>
                                                      <a type="button" class="btn btn-outline-info" href="<%= request.getContextPath() %>/changestatus/<%= act.getIdaction() %>">terminer action</a>
                                                </h3>

                                                <% } else {%>
                                               <h2> <small class="even-row-color" style="color: #0d6efd"> deja tournee</small></h2>
                                                <% } %>

                                             <% if (act.getIsValidate()==0) {%>
                                             <h3>
                                                  <small class="even-row-color" style="color: red">pas encore Validee</small>
                                             </h3>

                                              <% } else {%>
                                              <h2> <small class="even-row-color" style="color: #0d6efd">deja Valide</small></h2>
                                              <% } %>
